...
import { SubscriptionState} from '@frontegg/redux-store';
...
export class FronteggSubscriptionService {
  private subscriptionStateSubject = new BehaviorSubject<SubscriptionState['subscription']>({} as SubscriptionState['subscription']);

  get subscriptionState$(): Observable<SubscriptionState['subscription']> {
  ...
  constructor(private fronteggAppService: FronteggAppService) {
    ...
    this.fronteggAppService.subscriptionsState$.subscribe((subscriptionState) => {
      if (subscriptionState != null) {
        ...
        if (subscription?.externallyManaged || !subscription) {
          return null;
        }
